...
2) 更改 .vscode 位置 将 extension 目录中的 .vscode 目录直接移动到 root 目录中，并将其中的 launch.json 的内容做如下的修改：
...
3) 新增 watch 脚本 在 extension 中的 package.json 中新增 script：
...
1. 创建应用 view-vue 在 packages 目录下，执行：

   *注意 Project name 要命名为： view-vue*

2. 新增 watch 脚本 在 view-vue 中的 package.json 中新增 script：
...
3. 修改打包路径 在 view-vue 的 vite.config.ts 中新增：
...
1. 创建应用 view-react 在 packages 目录下，执行：
...
2. 新增 watch 脚本 在 view-react 中的 package.json 中新增 script：
...
3. 修改打包路径 在 view-react 的 vite.config.ts 中新增：
...
[![](https://raw.githubusercontent.com/liutaigang/vscode-webview-example/main/documents/assets/vue-view-sidebar-view.png)](https://raw.githubusercontent.com/liutaigang/vscode-webview-example/main/documents/assets/vue-view-sidebar-view.png)

将 view-react 应用的视图显示在 panel 中，效果如图：

[![](https://raw.githubusercontent.com/liutaigang/vscode-webview-example/main/documents/assets/react-view-panel-view.png)](https://raw.githubusercontent.com/liutaigang/vscode-webview-example/main/documents/assets/react-view-panel-view.png)
...
2. 实现 ViewProvider
   ...
   *注意*：`<!-- don't remove !! __webview_public_path__ -->` 需要放在 script 标签之前
   ...
   <https://github.com/liutaigang/vscode-webview-example/blob/main/packages/extension/src/view-provider/view-provider-panel.ts>

   <https://github.com/liutaigang/vscode-webview-example/blob/main/packages/extension/src/view-provider/view-provider-sidebar.ts>
...
* 点击 activitybar 上的图标：[![](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/activitybar-icon.png)](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/activitybar-icon.png)
...
[![](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/iframe-crosss-domain.png)](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/iframe-crosss-domain.png)
...
[![](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/jiagou.png)](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/jiagou.png)
...
[![](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/dependency.png)](https://raw.githubusercontent.com/liutaigang/vscode-webview-extension-example/main/documents/assets/dependency.png)
