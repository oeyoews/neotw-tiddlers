...
## [Understanding the trade-offs eliminated了解消除的权衡](#understanding-the-trade-offs-eliminated)
...
## [One battle-tested programming model一个久经考验的编程模型](#one-battle-tested-programming-model)
...
## [Under the hood of PPR小反刍兽疫的幕后花絮](#under-the-hood-of-ppr)
...
## [Not just for app shells不仅适用于应用 shell](#not-just-for-app-shells)
...
## [Open to all frameworks向所有框架开放](#open-to-all-frameworks)
...
## [Try PPR on Vercel today立即在 Vercel 上试用 PPR](#try-ppr-on-vercel-today)
